...
**Margin notes:** Some findings (notably "share secrets, share snacks," the dyslexic boys list, and Mia's "way with boys") derive from handwritten margin notes on the interview pages rather than from transcribed speech. These required interpretive reading and are marked with their source where they appear.
...
Bell is overrepresented in our interview sample (6 of 10 ranked girls). Johnson and Clendenon girls are almost entirely unheard from.

---

## 2. Clique Structure

Eight groups emerged from the page 30 circle diagram and Ada's debrief. They overlap — several girls sit in multiple circles.

### A. Ada's Two Overlapping Triads (Bell + Clendenon)
**Triad 1: Ada — Mia — Lou**
**Triad 2: Ada — Mia — Natalia** (formerly with Alicia)

**Correction (Ada's report review):** Ada describes two distinct groups, not a single five-person clique. Triad 1 (Ada/Mia/Lou) is the group that formed organically when Ada and Mia started saying hi to Lou after Lou drifted from the Indian girls. Triad 2 (Ada/Mia/Natalia) is the remnant of the original group that used to include Alicia. Ada and Mia are the common members across both. Olivia N is not placed in either triad by Ada — she sits across from them at lunch and hangs out with Kiara (Clendenon) at recess.

**Previous framing ("Core Five") was an analytical construction** that merged these two triads plus Olivia N into a single bloc. Ada does not describe it that way. The term "Core Five" is retained below as shorthand for the broader Ada-centered alliance (all five girls oriented toward Ada/Mia as the hub), but readers should understand that Ada perceives two overlapping triads, not one unified group.

Originally Mia/Natalia/Olivia N/Alicia, until Ada joined and Alicia was pushed out. A tight Ada–Mia–Natalia sub-clique formed, which "gotten mixed reactions" from others. Lou (Clendenon, new from UK) joined after the Indian girls "discluded her a little." The formation was gradual — "Mia and I mostly, like when we were bored, we ran around and said hi to [Lou] and eventually we just formed a group somehow." This is the group most girls in Bell homeroom orient toward, whether as members, aspirants, or exiles.

### B. The Chinese Girls / "Clover Cats" (cross-homeroom)
**Ashley — Mia — Olivia Q — Milan — Ellie**

Ashley's primary social world. Olivia Q (Bareres), Milan (Gryser), and Ellie (Gryser) are the "random Chinese girls" — Ashley's #1 picks (confirmed by Ada). Mia bridges into this group from the Core Four. The group has **chilly relations** (star notation on diagram) with the Indian girls but no active dispute.

### C. Alicia's Network (cross-homeroom)
**Alicia — Navya — Anyeshka**

**Correction (Ada's report review):** This is a three-person group, not four. Alice is a separate pairing with Alicia (see Group H), not part of this trio. Alicia's post-exile landing spot. She ranks Navya and Anyeshka as her tied #1s. This is a genuine cross-homeroom, cross-ethnic friendship network. Alicia continues to accumulate displaced friends — she is becoming a hub for girls who've fallen out of other groups.

### D. Indian Girls (cross-homeroom, not exclusively Babu)
**Navya — Anyeshka — Kaisha** (+ possibly others)

**Correction (Ada's report review):** Not all members are from Babu's class — the group is cross-homeroom. Anjolie and Lyla are NOT really in this group (previous report overstated their membership). Lou is "still kind of in the group, she just doesn't hang out with anyone that much" — the Lou migration was less complete than previously described; she's peripheral rather than fully departed. Lyla "might be joining the group" per Ada, but this is tentative.

Confirmed core members per Ada: Kaisha, Navya, and "all the other Indian kids." Babu homeroom is the center of gravity but not the boundary. **Note:** The group is not purely ethnic — it accepted Lou (white, British) and Maperi (Turkish) is currently embedded.
...
A pairing from the far-right circle on the diagram. Ada reportedly admires Kaisha. A sub-unit within the broader Indian girls group.

### G. Annie–Julia–Lyla (Bell)
**Annie — Julia — Lyla**

Per Ada: a self-contained Bell homeroom trio. **Correction (Ada's report review):** Lyla (L-I-L-A) was never friends with Alice — "they were actually enemies." Lyla was also never friends with Anjolie. (Both claims appeared in the earlier debrief but Ada now contradicts them — see "Lyla Discrepancy" note in Section 4.) Lyla's friends are Annie and Julia. **Note:** Lyla (L-I-L-A, Bell) and Leela (L-E-E-L-A, Clendenon) are two separate people — Ada emphasized this distinction.

### H. Alice–Alicia (Bell)
**Alice — Alicia**

Per Ada: Alice's best friend is Alicia. **Correction (Ada's report review):** "Alice was friends with Alicia about a week before Alice broke up with Lyla" — meaning the Alice-Alicia bond formed first, and the Alice-Lyla split followed. Alice is still friends with Alicia. This pairing overlaps with Alicia's broader network (Group C) but is a distinct two-person unit.
...
**Natalia's explicit preference (Ada's report review):** Ada asked Natalia directly: "Who do you like better? Mia and Ada, or Alicia?" Natalia asked if Mia and Ada come in a "one-pack"; Ada said yes. Natalia's answer: "Well, then I like you guys better because you give me good snacks." The contrast is specific: Alicia gives Natalia "an eighth of a piece of a chip that is broken," while Ada makes Natalia "mini sandwiches" and leaves enough for herself. This makes the snack economy concrete — Natalia's loyalty tracks directly with snack quality and generosity. It also confirms that Ada and Mia function as a unit ("one-pack") in others' eyes.

**Natalia's popularity (per Ada):** "She's nice and she has a sister named Daniela who's also popular." Ada attributes Natalia's popularity partly to sibling reflected status — Daniela's popularity rubs off.

#### 3.1c The Snack-Sharing Constitutional Crisis

**"Share secrets, share snacks, and have all the gossip" — the founding charter:** Ada defines three principles as the basis of her group. The original margin-note formulation was "share secrets, share snacks"; Ada's report review expanded it to a triad: "We share secrets, we share snacks, and we have all the gossip." Gossip — meaning intelligence about other girls' social movements — is the third pillar, consistent with the group's investment in reconnaissance (see Section 5.2). During the interview Ada tried arroz con pollo for the first time and commented that it tasted like what Natalia has for lunch. Ada is half Vietnamese and doesn't normally eat Mexican food at home — so this was a new food for her, and her immediate association was with Natalia. The detail illustrates how the snack-sharing principle extends beyond the classroom: even encountering an unfamiliar food, Ada's frame of reference is her friend's lunch.

**"Alicia could have joined if she shared snacks":** Ada's direct statement (margin notes), which reframes the Alicia situation. Alicia wasn't expelled for a single offense — she failed to meet the group's entry criterion. In Ada's telling, the door was open; Alicia chose not to walk through it. Whether Alicia understood this criterion is another question.

**The specific snacks:** Alicia reportedly won't share her snacks (strawberry covered pretzels, cheeto fries, chips) with certain girls. This came up in both Alicia's interview and Ada's debrief — confirmed from both sides.

**The snack-sharing ritual:** Ada describes four methods she and Mia use to share snacks in Bell's classroom: (1) Wait for designated snack time ("Ms. Bell lets us chillax and eat snack for three minutes"), walk to Mia's desk. (2) Choose each other as work partners, bring snacks over. (3) At the carpet, sneakily share. (4) "The throwing away stuff method" — rip off a piece of trash, go to trash can, give Mia snack on the way; receive "payment" on the way back.

The elaborate covert methods (especially #4, with its "payment" framing) reveal snack-sharing as a bonding ritual that reinforces the Ada-Mia pair bond through minor rule-breaking and reciprocity. Given this context, the snack refusal is more than a personal grievance — it's a violation of the group's constitutional principle. Ada sees it as Alicia refusing the social contract, not just being stingy.

#### 3.1d Alicia's Rebuilding
...
**Also on 3/25 — Anyeshka bathroom confession.** Ada interrogated Anyeshka in the bathroom: "Does Alicia talk about me?" Anyeshka initially resisted ("Why should I tell you?") but relented after Ada promised not to tell: "Fine, but you have to promise because then Alicia will get really mad at me." Anyeshka's report: Alicia "always says that you are stealing her friends and making her feel discluded even though you guys are not friends." Frequency: "every two recesses."

**Analytical notes:**
- **Ada has penetrated Alicia's inner circle.** Anyeshka is one of Alicia's three-pack (Group C) — the Alicia-Anyeshka bond is the strongest reciprocal friendship in the dataset. Yet Anyeshka leaked to Ada under minimal pressure (one "please"). Anyeshka's fear ("Alicia will get really mad at me") shows she knows this is a betrayal.
- **"Every two recesses"** — Alicia's complaints about Ada are regular and ongoing, not reactive to specific incidents. The content is consistent with what we've heard from other channels (Madeline's "stealing friends" accusation, Lyla's parroting below).
- **Ada promised not to tell — but told us.** Ada's intelligence-gathering instinct overrides confidentiality promises. She extracted the information, promised secrecy, then immediately shared it in debriefing. This is the same pattern as the founding charter's "all the gossip" pillar — information is currency, and hoarding it defeats the purpose.

**Also on 3/25 — Alice spreads the narrative to Lyla.** Alice wasn't just Alicia's companion during the confrontation — she was also "helping spread it to Lyla." Ada and Mia caught Alice mid-conversation with Lyla, heard their names, and confronted them. Alice denied it ("No"). Ada pressed Lyla directly: "Seriously, what did she tell you?" Lyla's answer: "Why are you guys stealing Alicia's friends?"

**Analytical notes:**
- **Alice's role expands.** From companion (Group H) to active propagandist — she's the messenger carrying Alicia's narrative from the confrontation to the Annie/Julia/Lyla trio (Group G). The information chain: Alicia → Alice → Lyla.
- **Lyla is receiving the narrative.** Lyla parroted the "stealing friends" accusation word-for-word. This means Alicia's framing has reached Group G — the trio that Alicia joined at lunch (3/23). The lunch-table alliance now has an ideological component: Lyla knows and endorses Alicia's version of events.
- **The Group G absorption is deepening.** Alicia moved to the Annie/Julia/Lyla lunch table on 3/23. By 3/25, Alice is actively spreading Alicia's narrative to Lyla. The formerly "self-contained" Bell trio is now integrated into the conflict — not just as Alicia's lunch companions but as recipients of her grievance narrative.
...
**Analytical note:** Ada frames Lou's value in instrumental terms ("she's useful to have") — useful because of what she knows about Alicia, not just because of friendship. This suggests a strategic dimension to the recruitment of Lou, whether conscious or not.
...
**The mediation model:** Ada reports that Kaisha "usually helps break up fights by getting information from both sides and she'll send the information to each other so they know what's going on." Critically, Ada adds: "She doesn't really say which side she's on. It seems like she's on both sides, which is not a bad thing." This is the same information-relay model that Natalia used to perform (see 3.1b above) before she lost her neutrality by landing on Ada's side. Kaisha may have inherited the role.
...
### Ada's Conflict Resolution Style
**New (Ada debrief).** Ada describes her own approach:

**Humor-based forced reconciliation:** "I don't really solve problems, but if I do, I kind of solve them by getting the two enemies together and saying, 'Now the bride and groom may kiss.' And then somehow they suddenly become friends." She reports this "usually works." It uses absurdist humor to defuse tension and skip past the actual conflict — no mediation, no information exchange, just a joke that forces both parties to laugh together. It works in minor disputes but wouldn't work for a conflict as deep as the Alicia situation (and notably, Ada hasn't tried it there).
...
### The Alice–Lyla Situation
**DISCREPANCY.** Ada's accounts of Alice and Lyla's relationship are contradictory across sessions:

- **Ada debrief (earlier):** Alice and Lyla were best friends but "broke up." Ada reported both sides — Alice said she was trying to be nice; Lyla said Alice was "being kind of mean and getting mad over little things" (example: Alice got angry when Lyla said she liked her family more than her). Lyla's best friend was said to be Anjolie.
- **Ada's report review (current):** "Lyla was never friends with Alice. They were actually enemies." "Lyla was never friends with Anjolie either."

These cannot both be true. Possible explanations: (1) Ada was confused or exaggerating in one session, (2) the relationship was brief enough that Ada retroactively reclassifies it as "never friends," (3) the earlier debrief captured a transitional moment that has since resolved differently. The earlier account included specific details (the loyalty test, both sides' perspectives) that suggest it wasn't fabricated, but Ada's current correction is emphatic.

**What we can say with confidence:** Alice's best friend is now Alicia. Alice befriended Alicia about a week before the Alice-Lyla split. Lyla is in the Annie/Julia trio (Group G). The Alice-Lyla relationship, whatever it was, is over.
...
**Devon (new name, 3/25):** Johnson homeroom. Top friends are **Olivia N and Julia** — both Bell homeroom, making Devon a cross-homeroom bridge into Bell's social world outside either bloc. Her willingness to report Madeline's gossip to Ada suggests she doesn't see herself as part of Madeline's social world despite being in the same homeroom.
...
### Ruby (new name)
**New (Ada remarks).** Ada reports that **Lou's best friend is Ruby** (unknown homeroom). An earlier remark also said **Lyla's best friends are Ruby and Anjolie** — but Ada's report review now says Lyla was never friends with Anjolie, which casts doubt on this claim. The Ruby-Lyla connection may still hold independently of the Anjolie connection. Ruby's homeroom is unknown — Ada says "I don't know which class Ruby's in."

**Note:** If the Ruby-Lou and Ruby-Lyla connections both hold, Ruby bridges two otherwise unconnected social worlds. Ruby may be a missing link in the network.
...
- **Alice:** "Funny but sometimes she can be a little rude." "Gets mad over little things or is mean to people." Alice is "one of the persons who like to ask people who they like better" — she poses comparison/loyalty questions (e.g., asking someone "who do you like better?").

### The Ethnic Partition
Chinese and Indian girls "don't really care for each other." This is pervasive enough that the consultant marked it with stars on the diagram. The separation tracks homeroom lines (Johnson = Chinese, Babu = Indian) but persists even in mixed settings. **Exceptions:** Mia (Chinese, but cordial with Indian girls), Ada (friends with Anjolie specifically, friendly with Indian girls generally), and Lou (was embedded in the Indian girls group and remains peripheral). ~~Lyla was previously listed as best friends with Anjolie, but Ada's report review contradicts this.~~ The exceptions are still accumulating — the partition may be less rigid than initially observed.

**Language note (Ada debrief):** Most girls speak English. Ada believes the Chinese girls (Mia's friends — presumably Olivia Q, Milan, Ellie, Ashley) sometimes speak Chinese when together: "I see her and her friends hanging out without Mia and they speak Chinese sometimes, so they might speak Chinese when they're together." Also notes **Maperi** (Babu homeroom, Turkish background) "doesn't know English that well, but she speaks English instead of Turkish." Language switching may reinforce the ethnic partition — the Chinese girls have a shared language that creates in-group moments inaccessible to others.

**Maperi (Babu homeroom):** Turkish girl, "silly," hangs out with the Indian kids in Babu's class. Ada isn't sure who her specific friends are. Notable: a non-Indian girl embedded in the Indian girls' group (similar to how Lou, a white British girl, was previously embedded there). The Indian girls group may be more ethnically open than the "ethnic partition" framing suggests — they absorb outsiders (Lou, Maperi) while the Chinese girls group appears more closed.

### Asymmetric Friendships
Several rankings are notably non-reciprocal:
- **Natalia** ranks Mallorie #1, but Mallorie hasn't been interviewed. Natalia does not rank any Core Four member above #3.
- **Olivia N** ranks Kiara (Clendenon) as her #1 — an out-of-homeroom, out-of-clique pick. Her Core Four membership may be more structural than felt.
- **Ada** ties Anjolie with Mia at #1. Anjolie ranks Ada only #2, behind Leela.
- **Anyeshka** ranks Alicia #1. Alicia ranks Anyeshka tied-#1 back — the strongest mutual bond in the dataset.
...
| **Lyla** | **DISCREPANCY.** Ada's accounts contradict each other — earlier said Lyla was friends with Alice (then broke up) and best friends with Anjolie; now says Lyla was "never friends" with either and they were "enemies." Get Lyla's own account to resolve. Who are her actual friends? |
...
### Lyla Discrepancy
Ada's accounts of Lyla's friendships contradict across sessions. The earlier debrief described an Alice-Lyla best friendship, a breakup, and a pivot to Anjolie. The report review says Lyla was "never friends with Alice" (they were "enemies") and "never friends with Anjolie." Both claims are attributed to Ada. This is the most significant internal inconsistency in our single-source data. Lyla herself is the only person who can resolve it; she is a priority for round 2.

### Unresolved references
- **"The Indian girls"** — Anjolie and Navya both cite this group collectively. Confirmed members: Kaisha, Navya, Anyeshka, Anjolie, Maperi (Turkish but embedded). **Note:** Babu homeroom has 6 girls total (adding Mallorie); if Babu ≈ Indian girls, the roster may be complete. Mallorie's membership is uncertain — she is Natalia's #1 but has not been placed in this group by any source.
...
## 5. Analysis: The Social Economy and Its Mechanisms

This section steps back from the narrative to identify the structural mechanisms operating across the girls' social world. These are recurring patterns — not one-off events — that shape how groups form, how conflict plays out, and how power circulates.

### 5.1 Exchange and Entry: The Snack-Sharing Constitution

Ada's group operates on an explicit social contract: "share secrets, share snacks, and have all the gossip." Ada articulated this triad as the founding principle of her group with Mia and Natalia.

The contract has three dimensions:

**Material reciprocity.** Snack-sharing is ritualized to a remarkable degree. Ada and Mia have developed four covert methods for exchanging snacks in class, including the "throwing away stuff method" — a trash-can relay with explicit "payment" framing. The elaborateness of the ritual signals that the exchange itself is the point, not the food. This is gift economy, not nutrition.

**Secrets as currency.** The other half of the charter — "share secrets" — creates a parallel information economy. Sharing secrets is a trust signal: you're giving someone leverage over you. Alicia's accusation that Ada and Mia are "telling secrets" is, in this framework, an accusation that they've debased the currency — sharing secrets outside the circle of trust.

**Gossip as operational capacity.** The third pillar — "we have all the gossip" — reframes intelligence-gathering (Section 5.2) as a group identity, not just a tactic. The group defines itself partly by its information advantage. This connects the social contract to the reconnaissance operations: sharing gossip is both a bonding activity and a strategic asset.

**Gatekeeping through the contract.** "Alicia could have joined if she shared snacks" makes the entry criterion explicit. The group isn't closed by decree — it's closed by a behavioral standard that Alicia failed to meet. Whether Alicia knew the standard existed is unclear, and this ambiguity may be part of how gatekeeping works: the rules are real but unwritten, and violating them can feel like exclusion rather than self-exclusion.

**Food as identity marker.** Ada trying arroz con pollo for the first time and immediately associating it with Natalia's lunch suggests that the snack-sharing principle extends beyond the classroom. Food becomes a medium for social connection — tasting what your friend tastes is a form of intimacy.

### 5.2 Intelligence and Reconnaissance

Information-gathering is a valued skill across the network, with different girls specializing in different intelligence domains.

**Lou: the defector-turned-scout.** Lou's former best-friendship with Alicia gives her insider knowledge of Alicia's patterns. Ada frames this value explicitly: "she's useful to have." Lou runs systematic behavioral tests — proximity tests using tag (observe Alicia's reaction) and gossip-detection approaches (infer from her facial expression whether she's been talking about them). These are not casual observations; they're designed experiments with predetermined interpretive frameworks.

**Mia: the cross-gender intelligence-gatherer.** Ada explains that Mia (and Ada herself) are "brave enough to occasionally talk to the boys and find out information about them." In a social world where boys and girls largely don't interact (except in Gryser's classroom), this takes genuine social courage. It's framed as one of Mia's assets — a skill she contributes to the group.
...
**Ada's intelligence coup: the Anyeshka bathroom confession (3/25).** Ada cornered Anyeshka in the bathroom and extracted a confession: Alicia complains about Ada "every two recesses," saying she's "stealing her friends and making her feel discluded." Anyeshka resisted initially but folded after Ada promised secrecy ("Alicia will get really mad at me"). This is Ada's most significant intelligence operation — she has penetrated Alicia's inner circle. Anyeshka is half of the strongest reciprocal friendship in the dataset (Alicia-Anyeshka), yet she leaked under minimal pressure. Ada's promise of confidentiality was immediately broken (she reported it in debriefing), consistent with the "all the gossip" pillar of the founding charter: information is for sharing, not hoarding.

**Devon as unwitting conduit (3/25).** Madeline told Devon (Johnson) that "Ada bullies me." Devon reported it to Ada. Devon's top friends are Olivia N and Julia (both Bell) — she's a cross-homeroom bridge whose loyalties lie outside Madeline's orbit. Not all Johnson girls are in Madeline's camp.
...
Two mediation models appear in the data, and one has already failed.

**The telephone model (Natalia, now defunct).** Natalia "used to be the peacemaker between Alicia and I — we would tell her something and she would tell the other person what we said. She'd just act as a telephone." This is passive relay — no interpretation, no judgment, just message-passing. It failed because Natalia ended up on Ada's side of the split and lost her neutrality. The mediator can't relay messages once she's a combatant.

**The active mediation model (Kaisha, under pressure).** Kaisha "usually helps break up fights by getting information from both sides and she'll send the information to each other." Unlike Natalia's telephone, Kaisha actively collects intelligence and redistributes it. Critically, she "doesn't really say which side she's on" — her value comes from neutrality. But both sides are exploiting her: Ada uses her as a social shield on Steam Day; the Alicia coalition's alliance-building includes Kaisha's Indian girls group members. Whether Kaisha is aware of this pressure is a key unknown.

**The mediator's dilemma.** Kaisha is valued precisely because she doesn't take sides — but both sides are trying to pull her onto theirs. If the two-bloc structure hardens, her neutral position becomes untenable. She'll either have to choose, or find a way to remain above the fray as the conflict intensifies.

### 5.5 Displacement and Accumulation

Two distinct mechanisms move girls between groups.

**Rupture → exile → landing.** Alicia's pattern. She was pushed out of the Core Four (or gradually separated — both narratives coexist). She rebuilt across three different groups: Navya/Anyeshka (Babu), Madeline/Sanvi (Johnson/Clendenon), and residual Bell friendships (Alice). The recurring pattern: girl gets expelled or alienated from a group → bonds with Alicia. Alice is the latest case, arriving after her breakup with Lyla. Alicia is becoming a hub for displaced friends — a structural bridge that exists precisely because of her exile.

**Drift → partial absorption.** Lou's pattern. The Indian girls "discluded her a little" — not outright meanness, just gradual exclusion. Ada and Mia "would say hi when bored," and "eventually we just formed a group somehow." No dramatic break, no clear before-and-after. **Correction:** Ada's report review clarifies that Lou is "still kind of in" the Indian girls group — "she just doesn't hang out with anyone that much." The migration is less complete than previously described; Lou is peripheral to both groups rather than fully transferred. Ada frames Lou's absorption partly in instrumental terms ("she's useful to have" because of what she knows about Alicia). Even organic group formation can have strategic dimensions.

**Active recruitment of isolates.** Alicia proactively befriends new and displaced girls. When Lou first arrived and "had no one," Alicia walked over and said "Sup, Lou?" This is the same pattern seen with Alice (who came to Alicia after the Lyla split) and potentially with Navya and Anyeshka. Alicia doesn't wait for displaced girls to find her — she approaches them.

**The paradox of Alicia's position.** Alicia's exile from the Core Four is what makes her structurally interesting. By accumulating displaced friends from different homerooms and ethnic groups, she's built the most cross-cutting network in the system. Her weakness (being pushed out) became her structural advantage (bridging otherwise disconnected social worlds).

### 5.6 The Ethnic Partition and Its Limits

The Chinese-Indian partition is real but leakier than it initially appeared.

**The core finding.** Chinese and Indian girls "don't really care for each other" — a passive estrangement marked with stars on the consultant's diagram. It tracks homeroom lines (Johnson ≈ Chinese, Babu ≈ Indian) but persists beyond homeroom settings.

**Differential permeability.** The Indian girls group is more ethnically open. It accepted Lou (white, British) before the rupture, and Maperi (Turkish) is currently embedded. The Chinese girls group appears more closed — bonded by shared language (they speak Chinese when together, creating in-group moments inaccessible to non-speakers).

**Bridge figures.** The partition is challenged by at least three girls: Mia (Chinese, but in Ada's group and cordial with Indian girls), Ada (half Vietnamese, friends with Anjolie), and Lou (still peripherally in the Indian group while also in Ada's orbit). ~~Lyla was previously listed as a bridge via Anjolie, but Ada's report review contradicts this.~~ The exceptions still suggest the partition describes centers of gravity rather than hard boundaries.

**Language as boundary maintenance.** Chinese girls' use of Chinese when together creates moments of exclusion that reinforce the in-group boundary. Maperi, interestingly, goes the other way — she "doesn't know English that well, but speaks English instead of Turkish," choosing the lingua franca over her home language. Language choices signal where you want to belong.

### 5.7 Structural Holes and Scheduling Effects

The physical and institutional infrastructure of the school shapes social possibilities in ways the girls may not recognize.

**Homeroom as primary sort.** Homeroom determines who you see in class, where you sit at lunch, and which girls are available for moment-to-moment interaction. But the most socially interesting action — cross-group friendships, intelligence operations, alliance formation — happens at recess, when homeroom constraints dissolve. Recess is the arena where the real social map gets drawn.
...
- **Madeline's narrative leaks.** Madeline told Devon (Johnson) that "Ada bullies me and she also talks behind my back and glares at me." Devon reported this to Ada. Two implications: (1) Madeline is now framing the conflict as "bullying" rather than "friend-stealing" — a rhetorical escalation that invokes more serious social categories; (2) not all Johnson girls are in Madeline's camp. Devon's top friends are Olivia N and Julia (both Bell), placing her outside the conflict's core; her act of reporting to Ada makes her a de facto intelligence asset for Bloc 1.
- **Alice spreads the narrative to Lyla.** Alice, present during the confrontation as Alicia's companion, then "helped spread it to Lyla." Ada caught Alice mid-conversation with Lyla and confronted them; Lyla's response was "Why are you guys stealing Alicia's friends?" — parroting Alicia's framing. This means the "friend-stealing" narrative has reached Group G (Annie/Julia/Lyla) through Alice as intermediary. The formerly self-contained Bell trio is now ideologically integrated into Bloc 2.
- **Anyeshka leaks to Ada.** Ada cornered Anyeshka in the bathroom and extracted a confession: Alicia complains about Ada "every two recesses," saying she's "stealing friends and making her feel discluded." Anyeshka's fear of Alicia's reaction shows she knows she betrayed a confidence. This is a crack in Bloc 2's inner circle — one of Alicia's strongest allies is leaking intelligence to the other side under minimal pressure.
...
2. **For Alice:** "Who's your best friend right now? How did you and Alicia become friends?" (Ada says Alice befriended Alicia about a week before the split with Lyla. Probe the timeline — was Alicia the catalyst for the Lyla split, or a landing spot after it?)
3. **For Lyla:** "Who are your best friends right now? Who do you hang out with at recess?" (Ada's accounts of Lyla are contradictory — earlier debrief said she was friends with Alice and then Anjolie; report review says she was never friends with either and they were "enemies." Get Lyla's own account to resolve the discrepancy.)
...
13. **For Devon (round 2):** "Who are your friends? You're in Johnson's class — do you hang out with Madeline, or more with other girls?" (Devon's top friends are Olivia N and Julia, both Bell — she bridges Johnson into Bell. She reported Madeline's gossip to Ada, suggesting she's not allied with Madeline. Get her perspective on Johnson homeroom dynamics.)
15. **For Anyeshka (round 2):** "How are things with Alicia? Do you ever feel caught in the middle between Alicia and other girls?" (Anyeshka leaked to Ada in the bathroom on 3/25 — she may be feeling pressure from both sides. Probe whether her loyalty to Alicia is weakening or whether the leak was situational.)
